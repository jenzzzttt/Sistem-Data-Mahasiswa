...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Data Mahasiswa Pengkodean dan Pemrograman</a>
          ...
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                         ...
                         Naila Rif'ah Amelia (12030122130143)
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.data_siswa', {
          duration: 1,
          delay: 0.6,
          text: 'Daftar Peserta Pengkodean dan Pemrograman :)'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
